...
// Conexão de Página do Facebook. Scopes válidos no Login do Facebook.
// (instagram_* pertence ao botão Instagram, não aqui.)
// pages_manage_posts (publicar na Página) entra após App Review.
